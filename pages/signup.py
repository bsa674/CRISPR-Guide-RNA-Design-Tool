...
if ss.page_state == 'signup':
    st.set_page_config(page_title="Castor: A CRISPR Guide RNA Design Tool",layout="wide",page_icon=img_path,
...
def signup():
    ...
    # Add the glass-form class using markdown
        ...
        password_conf = st.text_input("Confirm Password", placeholder="Confirm your password", type="password")
...
if __name__ == "__main__":
    with st.container():
        ...
        with signup_space:
            st.markdown("<h1 style='text-align: center; color: white;'>Create your account</h1>", unsafe_allow_html=True)
